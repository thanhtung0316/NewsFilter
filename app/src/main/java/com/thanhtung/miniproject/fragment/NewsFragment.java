...
import com.thanhtung.miniproject.api.ApiBuilder;
import com.thanhtung.miniproject.api.DialogUtils;
import com.thanhtung.miniproject.dao.AppDatabase;
import com.thanhtung.miniproject.download.DownloadAsync;
...
public class NewsFragment extends BaseFragment<MainActivity> implements Callback<NewsResponsive>, SearchView.OnQueryTextListener, NewsAdapter.FaceItemListener, View.OnClickListener, DownloadAsync.DownloadCallback {
    ...
    public boolean onQueryTextSubmit(String query) {
        DialogUtils.show(NewsFragment.super.getContext());
        String keySearch = searchView.getQuery().toString();
        String apiKey = "df459e641ab049f7a109d69ebbd3e584";
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (checkPermission()) {
            Toast.makeText(getActivity(), "ACCESS GRANDTED!", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(getActivity(), "ACCESS DINIED!!", Toast.LENGTH_SHORT).show();
        }
    ...
    private void showAddDialog() {
        ...
        imvBack = dialog.findViewById(R.id.im_back);
